...
class ContrastiveSentLoss(nn.Module):
    """
    ...
    def __init__(self, model, distance_metric=SiameseDistanceMetric.COSINE_DISTANCE,
                 margin: float = 0.5, size_average: bool = True):
        super(ContrastiveSentLoss, self).__init__()
