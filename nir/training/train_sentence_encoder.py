...
from nir.training.utils import _train_sentence_transformer, tokenize_function
...
def train_huggingface_transformer(model_fp_or_name_or_cls: Union[str, transformers.PreTrainedModel],
    ...
    training_args = TrainingArguments(output_dir=output_dir,
                                      ...
                                      optim=optimizer,
                                      prediction_loss_only=True if metric is None and compute_metric_fn is None else False,
                                      fp16=True)
    ...
    trainer = Trainer(
        ...
        compute_metrics=partial(compute_metric_fn, metric) if compute_metric_fn else None,
    )
