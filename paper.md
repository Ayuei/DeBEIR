...
Although cross-encoders are more accurate/effective than bi-encoders, the utility of the bi-encoder is that they are more effective than BM25 [@search-like-an-expert-2022] and are faster than cross-encoders. Therefore, a gap in the literature in IR is to replace BM25 first-stage retrieval with a bi-encoder or
...
More information on the library is found on the GitHub page, <a href="https://www.github.com/ayuei/debeir" target="_blank"> DeBeIR</a>. Any feedback and suggestions are welcome by opening a thread in <a href="https://www.github.com/ayuei/debeir/issues" target="_blank"> issues</a>.
